...
namespace @__default {
    ...
    public partial class HostConstants {
        ...
        // extended
        public static void AskForOverwrite(char[] dest, out bool overwrite) {
            try {
                System.Console.Write($"File '{new string(dest)}' already exists. Overwrite? [y/N] ");
                string line = System.Console.ReadLine();
                overwrite = line != null && line.Length > 0 && line.ToLower()[0] == 'y';
            } catch (Exception e) {
